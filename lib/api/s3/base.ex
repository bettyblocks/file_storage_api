defmodule FileStorageApi.API.S3.Base do
  ...
  def config(%{config: s3_config}) do
    [
      access_key_id: Map.get(s3_config, :access_key),
      secret_access_key: Map.get(s3_config, :secret_key),
      s3_auth_version: Map.get(s3_config, :s3_auth_version, 4),
